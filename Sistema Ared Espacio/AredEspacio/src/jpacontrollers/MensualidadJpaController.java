...
public class MensualidadJpaController implements Serializable {
    ...
    public void create(Mensualidad mensualidad) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findMensualidad(mensualidad.getIDMensualidad()) != null) {
                throw new PreexistingEntityException("Mensualidad " + mensualidad + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
